          ...
          <SafeAreaView style={{flex: 1}}>
            <View
              style={[
                ...
                {width: this.props.role === 'Seller' ? '100%' : '70%'},
              ]}>
              <TouchableOpacity
                onPress={() => this.setState({selectedCategory: 0})}
                style={{
                  borderBottomWidth: this.state.selectedCategory === 0 ? 5 : 0,
                  borderBottomColor: RED.dark,
                }}>
                <Text style={styles.SelectText}>Delivered</Text>
              </TouchableOpacity>

              <TouchableOpacity
                onPress={() => this.setState({selectedCategory: 1})}
                style={{
                  borderBottomWidth: this.state.selectedCategory === 1 ? 5 : 0,
                  borderBottomColor: RED.dark,
                }}>
                <Text style={styles.SelectText}>Orders</Text>
              </TouchableOpacity>
              {this.props.role === 'Seller' ? (
                <TouchableOpacity
                  ...
                  style={{
                    borderBottomWidth:
                      this.state.selectedCategory === 2 ? 5 : 0,
                    borderBottomColor: RED.dark,
                  }}>
                  <Text style={styles.SelectText}>Out of Stock</Text>
                </TouchableOpacity>
              ) : null}
            </View>
              ...
              {this.state.selectedCategory === 2 && (
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <TouchableOpacity
                      onPress={() =>
                        this.setState({modalVisible: true, p_id: item.id})
                      }
