    ...
    return (
      <View style={styles.wrapperView}>
        ...
        <View style={styles.headerView}>
            ...
            <Image 
            style={{width: 25, height: 15, marginRight: isIphoneXorAbove ? 90 : 60, resizeMode:'contain'}}
            source={require('../../assets/backblack.png')}/>
            </TouchableOpacity>
            <Text style={{fontSize: 24, fontWeight: '600', color: BLACK.dark}}>Add Card</Text>
          </View>
          <View style={{flex:1,width: SCREEN.width - 40, alignSelf:'center'}}>
            ...
            <TouchableOpacity 
            onPress={()=> this.props.navigation.navigate("Information",{data:this.state.data})}
            style={styles.Btn}>
